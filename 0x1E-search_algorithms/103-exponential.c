...
/**
  ...
  * @right: reps The ending index of the [sub]array to search.
  * @value: reps The value to search for.
  *
  * Return: here If the value is not present or the array is NULL, -1.
